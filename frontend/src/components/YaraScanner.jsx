      ...
      >
        ...
        >
          ...
          {results.map((result, index) => (
            <motion.div key={index} variants={resultItemVariants}>
              <Accordion sx={{ mb: 1 }}>
                <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                  <Box
                    sx={{
            ...
            >
              <AnimatePresence mode="wait">
                {scanResult || batchScanResult ? (
                  ...
                  >
                    {batchMode
                      ? renderBatchScanResult()
                      : renderSingleScanResult()}
                  </motion.div>
                ) : (
                  <motion.div
                    key="empty"
                    ...
                    >
                      <Box sx={{ textAlign: "center", p: 4 }}>
                        ...
                        <CozySecondaryTypography
                          ...
                          sx={{ opacity: 0.5 }}
                        >
                          Upload a file and start scanning to see detailed
                          results
                        </CozySecondaryTypography>
                      </Box>
                    </Box>
